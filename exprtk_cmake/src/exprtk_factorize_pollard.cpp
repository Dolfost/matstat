...
void factorize_pollards_rho()
{
   ...
   symbol_table.add_vector  ("composities", composities);
   ...
   const std::string factorize_composities_program =
      " for (var i := 0; i < composities[]; i += 1)                              "
      " {                                                                        "
      "    var n       := composities[i];                                        "
   ...
   parser.compile(factorize_composities_program,expression);
