...
badd +83 exprtk_cmake/readme.txt
...
badd +295 include/gui/vectorContainerWidget.cpp
...
badd +66 include/statistics/distributionReproducer.hpp
badd +316 include/statistics/distributionReproducer.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 461 - ((30 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 461
...
silent! normal! zE
let &fdl = &fdl
let s:l = 166 - ((21 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 166
...
silent! normal! zE
let &fdl = &fdl
let s:l = 26 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 26
...
silent! normal! zE
let &fdl = &fdl
let s:l = 295 - ((12 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 295
...
silent! normal! zE
let &fdl = &fdl
let s:l = 316 - ((12 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 316
...
silent! normal! zE
let &fdl = &fdl
let s:l = 83 - ((24 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 83
...
silent! normal! zE
let &fdl = &fdl
let s:l = 102 - ((35 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 102
...
silent! normal! zE
let &fdl = &fdl
let s:l = 145 - ((27 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 145
