...
badd +438 include/statistics/dataVector.cpp
...
badd +19 include/gui/mainWindow.cpp
...
badd +318 include/gui/vectorContainerWidget.cpp
...
badd +301 include/gui/vectorProcessorWidget.cpp
...
badd +130 include/gui/setGeneratorDialog.cpp
badd +73 include/gui/setGeneratorDialog.hpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 295 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 295
...
silent! normal! zE
let &fdl = &fdl
let s:l = 70 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 70
...
silent! normal! zE
let &fdl = &fdl
let s:l = 321 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 321
...
silent! normal! zE
let &fdl = &fdl
let s:l = 62 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 62
...
silent! normal! zE
let &fdl = &fdl
let s:l = 438 - ((9 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 438
...
silent! normal! zE
let &fdl = &fdl
let s:l = 45 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 45
...
silent! normal! zE
let &fdl = &fdl
let s:l = 55 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 55
...
silent! normal! zE
let &fdl = &fdl
let s:l = 138 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 138
...
silent! normal! zE
let &fdl = &fdl
let s:l = 38 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 38
...
silent! normal! zE
let &fdl = &fdl
let s:l = 44 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 44
