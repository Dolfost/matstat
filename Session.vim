...
badd +146 include/statistics/dataVector.hpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 18 - ((11 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 18
...
silent! normal! zE
let &fdl = &fdl
let s:l = 112 - ((21 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 112
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
silent! normal! zE
let &fdl = &fdl
let s:l = 154 - ((29 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 154
...
silent! normal! zE
let &fdl = &fdl
let s:l = 27 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 27
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 27 + 21) / 43)
exe 'vert 1resize ' . ((&columns * 119 + 96) / 192)
exe '2resize ' . ((&lines * 27 + 21) / 43)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 100 - ((8 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 100
...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((0 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
...
silent! normal! zE
let &fdl = &fdl
let s:l = 113 - ((20 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 113
...
silent! normal! zE
let &fdl = &fdl
let s:l = 80 - ((9 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 80
...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((0 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 16
...
silent! normal! zE
let &fdl = &fdl
let s:l = 544 - ((21 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 544
...
silent! normal! zE
let &fdl = &fdl
let s:l = 146 - ((16 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 146
...
silent! normal! zE
let &fdl = &fdl
let s:l = 2286 - ((9 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2286
