...
badd +52 include/gui/mainWindow.cpp
...
badd +70 include/gui/vectorProcessorWidget.hpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 321 - ((22 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 321
...
silent! normal! zE
let &fdl = &fdl
let s:l = 62 - ((31 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 62
...
silent! normal! zE
let &fdl = &fdl
let s:l = 193 - ((29 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 193
...
silent! normal! zE
let &fdl = &fdl
let s:l = 55 - ((0 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 55
