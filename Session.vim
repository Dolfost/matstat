...
badd +285 include/statistics/dataVector.hpp
badd +342 include/statistics/dataVector.cpp
...
badd +22 include/statistics/densityChart.cpp
...
badd +40 include/gui/transformationFormulaEditorDialog.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 217 - ((14 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 217
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
silent! normal! zE
let &fdl = &fdl
let s:l = 129 - ((20 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 129
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43 - ((17 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43
...
silent! normal! zE
let &fdl = &fdl
let s:l = 30 - ((24 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 30
...
silent! normal! zE
let &fdl = &fdl
let s:l = 128 - ((18 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 128
...
silent! normal! zE
let &fdl = &fdl
let s:l = 113 - ((21 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 113
...
silent! normal! zE
let &fdl = &fdl
let s:l = 80 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 80
...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((0 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 16
...
silent! normal! zE
let &fdl = &fdl
let s:l = 342 - ((16 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 342
...
silent! normal! zE
let &fdl = &fdl
let s:l = 270 - ((15 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 270
