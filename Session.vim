...
badd +39 include/gui/mainWindow.hpp
badd +84 include/gui/mainWindow.cpp
...
badd +49 include/gui/vectorContainerWidget.cpp
badd +29 include/gui/vectorInfoDialog.hpp
badd +1 include/gui/vectorInfoDialog.cpp
badd +18 include/statistics/varSeries.hpp
badd +26 include/gui/vectorProcessorWidget.hpp
badd +6 include/gui/vectorProcessorWidget.cpp
badd +11 include/gui/guiTypes.hpp
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 229 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 229
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((23 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 51
...
silent! normal! zE
let &fdl = &fdl
let s:l = 49 - ((16 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 49
...
silent! normal! zE
let &fdl = &fdl
let s:l = 29 - ((0 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
...
silent! normal! zE
let &fdl = &fdl
let s:l = 84 - ((16 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 84
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39 - ((16 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
...
silent! normal! zE
let &fdl = &fdl
let s:l = 83 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 83
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 42
...
silent! normal! zE
let &fdl = &fdl
let s:l = 843 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 843
...
silent! normal! zE
let &fdl = &fdl
let s:l = 418 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 418
