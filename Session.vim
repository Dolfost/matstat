...
badd +13 include/statistics/densityChart.hpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 28 - ((23 * winheight(0) + 16) / 33)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 34 - ((14 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 34
...
silent! normal! zE
let &fdl = &fdl
let s:l = 10 - ((8 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 10
...
silent! normal! zE
let &fdl = &fdl
let s:l = 14 - ((10 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 14
...
silent! normal! zE
let &fdl = &fdl
let s:l = 13 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 13
