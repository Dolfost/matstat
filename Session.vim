...
badd +552 include/statistics/dataVector.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 50 - ((13 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
silent! normal! zE
let &fdl = &fdl
let s:l = 100 - ((8 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 100
...
silent! normal! zE
let &fdl = &fdl
let s:l = 113 - ((18 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 113
...
silent! normal! zE
let &fdl = &fdl
let s:l = 54 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 54
...
silent! normal! zE
let &fdl = &fdl
let s:l = 80 - ((8 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 80
...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 16
...
silent! normal! zE
let &fdl = &fdl
let s:l = 695 - ((28 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 695
...
silent! normal! zE
let &fdl = &fdl
let s:l = 412 - ((12 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 412
...
silent! normal! zE
let &fdl = &fdl
let s:l = 2286 - ((8 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 2286
