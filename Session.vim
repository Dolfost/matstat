...
badd +845 include/statistics/dataVector.cpp
badd +1 include/statistics/classSeries.cpp
badd +25 include/statistics/classSeries.hpp
...
badd +25 include/gui/mainWindow.hpp
badd +39 include/gui/mainWindow.cpp
badd +24 CMakeLists.txt
badd +2286 exprtk_cmake/readme.txt
badd +7 include/gui/Section.cpp
badd +29 include/gui/vectorContainerWidget.hpp
badd +83 include/gui/transformationFormulaEditorDialog.cpp
badd +51 include/gui/vectorPickerDialog.hpp
badd +41 include/gui/transformationFormulaEditorDialog.hpp
badd +1 include/gui/vectorPickerDialog.cpp
badd +46 include/gui/vectorContainerWidget.cpp
badd +29 include/gui/vectorInfoDialog.hpp
badd +229 include/gui/vectorInfoDialog.cpp
badd +18 include/statistics/varSeries.hpp
badd +25 include/gui/vectorProcessorWidget.hpp
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 30 + 19) / 39)
exe 'vert 1resize ' . ((&columns * 108 + 96) / 192)
exe '2resize ' . ((&lines * 30 + 19) / 39)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 229 - ((28 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 229
...
silent! normal! zE
let &fdl = &fdl
let s:l = 29 - ((18 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((26 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 51
...
silent! normal! zE
let &fdl = &fdl
let s:l = 46 - ((15 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
...
silent! normal! zE
let &fdl = &fdl
let s:l = 29 - ((16 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 29
...
silent! normal! zE
let &fdl = &fdl
let s:l = 25 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 25
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((26 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 42
...
silent! normal! zE
let &fdl = &fdl
let s:l = 843 - ((21 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 843
...
silent! normal! zE
let &fdl = &fdl
let s:l = 418 - ((23 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 418
