...
badd +320 include/gui/vectorContainerWidget.cpp
badd +40 include/gui/vectorInfoDialog.hpp
badd +230 include/gui/vectorInfoDialog.cpp
badd +6 include/statistics/varSeries.hpp
badd +89 include/gui/vectorProcessorWidget.hpp
badd +275 include/gui/vectorProcessorWidget.cpp
...
badd +13 include/statistics/distributionReproducer.hpp
badd +98 include/statistics/distributionReproducer.cpp
badd +194 include/gui/distributionReproducerDialog.cpp
badd +36 include/gui/distributionReproducerDialog.hpp
...
badd +3 include/statistics/varSeries.cpp
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 82 - ((17 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 82
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((27 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((24 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 86 + 106) / 213)
exe 'vert 2resize ' . ((&columns * 126 + 106) / 213)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((22 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 47
...
silent! normal! zE
let &fdl = &fdl
let s:l = 140 - ((25 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 140
...
exe 'vert 2resize ' . ((&columns * 126 + 106) / 213)
tabnext
edit include/statistics/varSeries.cpp
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
exe 'vert 2resize ' . ((&columns * 106 + 106) / 213)
argglobal
balt include/statistics/varSeries.hpp
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists(fnamemodify("include/statistics/varSeries.hpp", ":p")) | buffer include/statistics/varSeries.hpp | else | edit include/statistics/varSeries.hpp | endif
if &buftype ==# 'terminal'
  silent file include/statistics/varSeries.hpp
endif
balt include/statistics/varSeries.cpp
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
