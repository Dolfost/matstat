...
badd +13 main.cpp
badd +95 include/statistics/plotBase.cpp
...
badd +47 include/gui/vectorPicker.hpp
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 95 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 95
...
silent! normal! zE
let &fdl = &fdl
let s:l = 66 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 66
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((8 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
...
silent! normal! zE
let &fdl = &fdl
let s:l = 152 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 152
...
silent! normal! zE
let &fdl = &fdl
let s:l = 32 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 32
...
silent! normal! zE
let &fdl = &fdl
let s:l = 121 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 121
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 18 + 18) / 37)
exe 'vert 1resize ' . ((&columns * 105 + 106) / 213)
exe '2resize ' . ((&lines * 18 + 18) / 37)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 99 - ((17 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 99
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((26 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
...
silent! normal! zE
let &fdl = &fdl
let s:l = 14 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 14
