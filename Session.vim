...
badd +114 include/statistics/dataVector.hpp
...
badd +209 include/statistics/distributionReproducer.cpp
badd +1 include/gui/distributionReproducerDialog.cpp
badd +41 include/gui/distributionReproducerDialog.hpp
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((23 * winheight(0) + 21) / 43)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 102 - ((8 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 102
...
silent! normal! zE
let &fdl = &fdl
let s:l = 35 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 35
...
silent! normal! zE
let &fdl = &fdl
let s:l = 119 - ((12 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 119
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
silent! normal! zE
let &fdl = &fdl
let s:l = 148 - ((28 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 148
...
silent! normal! zE
let &fdl = &fdl
let s:l = 209 - ((28 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 209
...
silent! normal! zE
let &fdl = &fdl
let s:l = 24 - ((14 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 24
...
silent! normal! zE
let &fdl = &fdl
let s:l = 533 - ((7 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 533
...
silent! normal! zE
let &fdl = &fdl
let s:l = 91 - ((8 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 91
