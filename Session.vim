...
badd +17 include/statistics/distributionChart.cpp
...
badd +139 include/gui/mainWindow.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 37 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 37
...
silent! normal! zE
let &fdl = &fdl
let s:l = 38 - ((13 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 38
...
silent! normal! zE
let &fdl = &fdl
let s:l = 19 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 19
...
silent! normal! zE
let &fdl = &fdl
let s:l = 17 - ((9 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 17
...
silent! normal! zE
let &fdl = &fdl
let s:l = 150 - ((25 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 150
...
silent! normal! zE
let &fdl = &fdl
let s:l = 117 - ((22 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 117
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
silent! normal! zE
let &fdl = &fdl
let s:l = 103 - ((17 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 103
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((11 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((16 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
