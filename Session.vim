...
badd +244 include/statistics/dataVector.cpp
badd +31 include/statistics/classSeries.cpp
...
badd +46 include/gui/mainWindow.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((9 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 105 + 96) / 192)
exe 'vert 2resize ' . ((&columns * 86 + 96) / 192)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 50 - ((12 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43 - ((12 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43
...
silent! normal! zE
let &fdl = &fdl
let s:l = 46 - ((26 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
...
silent! normal! zE
let &fdl = &fdl
let s:l = 244 - ((22 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 244
