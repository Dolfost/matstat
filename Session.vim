...
silent! normal! zE
let &fdl = &fdl
let s:l = 217 - ((14 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 217
...
silent! normal! zE
let &fdl = &fdl
let s:l = 37 - ((7 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 37
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((9 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((7 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 15
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 108 + 85) / 171)
exe 'vert 2resize ' . ((&columns * 62 + 85) / 171)
argglobal
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 94 + 85) / 171)
exe 'vert 2resize ' . ((&columns * 76 + 85) / 171)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
silent! normal! zE
let &fdl = &fdl
let s:l = 99 - ((17 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 99
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((13 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
...
silent! normal! zE
let &fdl = &fdl
let s:l = 54 - ((31 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 54
...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((7 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 16
...
silent! normal! zE
let &fdl = &fdl
let s:l = 249 - ((8 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 249
...
silent! normal! zE
let &fdl = &fdl
let s:l = 279 - ((16 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 279
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((17 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
...
silent! normal! zE
let &fdl = &fdl
let s:l = 12 - ((7 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 12
