...
badd +127 include/statistics/dataVector.hpp
badd +749 include/statistics/dataVector.cpp
...
badd +241 include/gui/vectorContainerWidget.cpp
...
badd +25 include/gui/vectorTrimmerDialog.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 14 - ((12 * winheight(0) + 17) / 35)
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 35 + 23) / 46)
exe 'vert 1resize ' . ((&columns * 132 + 95) / 190)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 213 - ((16 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 213
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40 - ((7 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 40
...
exe 'vert 2resize ' . ((&columns * 68 + 95) / 190)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 236 - ((34 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 236
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((35 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 51
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 131 + 95) / 190)
exe 'vert 2resize ' . ((&columns * 58 + 95) / 190)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 300 - ((31 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 300
...
silent! normal! zE
let &fdl = &fdl
let s:l = 83 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 83
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 118 + 95) / 190)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((20 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
silent! normal! zE
let &fdl = &fdl
let s:l = 21 - ((0 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 21
...
silent! normal! zE
let &fdl = &fdl
let s:l = 730 - ((34 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 730
...
silent! normal! zE
let &fdl = &fdl
let s:l = 127 - ((25 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 127
...
set winwidth=1
exe '1resize ' . ((&lines * 35 + 23) / 46)
exe 'vert 1resize ' . ((&columns * 101 + 95) / 190)
exe '2resize ' . ((&lines * 35 + 23) / 46)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 89 - ((26 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 89
