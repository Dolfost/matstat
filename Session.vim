...
badd +10 main.cpp
badd +242 include/statistics/plotBase.cpp
badd +62 include/statistics/plotBase.hpp
badd +1 include/statistics/dataSeries.cpp
badd +1 include/statistics/dataSeries.hpp
badd +58 include/statistics/dataVector.hpp
badd +269 include/statistics/dataVector.cpp
...
badd +22 include/gui/mainWindow.hpp
badd +88 include/gui/mainWindow.cpp
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 242 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 242
...
silent! normal! zE
let &fdl = &fdl
let s:l = 38 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 38
...
silent! normal! zE
let &fdl = &fdl
let s:l = 88 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 88
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 84 + 74) / 148)
exe 'vert 2resize ' . ((&columns * 63 + 74) / 148)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 251 - ((8 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 251
...
silent! normal! zE
let &fdl = &fdl
let s:l = 56 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 56
...
silent! normal! zE
let &fdl = &fdl
let s:l = 21 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 21
