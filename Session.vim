...
badd +96 include/statistics/dataVector.hpp
badd +542 include/statistics/dataVector.cpp
...
badd +173 include/gui/vectorInfoDialog.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 120 - ((31 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 120
...
silent! normal! zE
let &fdl = &fdl
let s:l = 128 - ((18 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 128
...
silent! normal! zE
let &fdl = &fdl
let s:l = 113 - ((25 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 113
...
silent! normal! zE
let &fdl = &fdl
let s:l = 54 - ((0 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 54
...
silent! normal! zE
let &fdl = &fdl
let s:l = 80 - ((11 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 80
...
silent! normal! zE
let &fdl = &fdl
let s:l = 542 - ((23 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 542
