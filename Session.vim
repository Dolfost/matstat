...
badd +323 include/statistics/dataVector.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 217 - ((8 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 217
...
silent! normal! zE
let &fdl = &fdl
let s:l = 42 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 42
...
silent! normal! zE
let &fdl = &fdl
let s:l = 52 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 52
...
silent! normal! zE
let &fdl = &fdl
let s:l = 311 - ((13 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 311
