...
badd +10 main.cpp
badd +212 include/statistics/plotBase.cpp
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 93 + 80) / 160)
exe 'vert 2resize ' . ((&columns * 66 + 80) / 160)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 212 - ((8 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 212
...
silent! normal! zE
let &fdl = &fdl
let s:l = 48 - ((13 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 48
...
silent! normal! zE
let &fdl = &fdl
let s:l = 38 - ((24 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 38
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 94 + 80) / 160)
exe 'vert 2resize ' . ((&columns * 65 + 80) / 160)
argglobal
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
...
silent! normal! zE
let &fdl = &fdl
let s:l = 78 - ((20 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 78
...
set winwidth=1
exe '1resize ' . ((&lines * 30 + 17) / 34)
exe 'vert 1resize ' . ((&columns * 58 + 80) / 160)
exe '2resize ' . ((&lines * 30 + 17) / 34)
exe 'vert 2resize ' . ((&columns * 101 + 80) / 160)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((12 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
silent! normal! zE
let &fdl = &fdl
let s:l = 39 - ((27 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 39
