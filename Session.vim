...
badd +62 include/statistics/classSeries.cpp
...
badd +150 include/gui/mainWindow.cpp
...
badd +289 include/gui/vectorProcessorWidget.cpp
...
silent! normal! zE
let &fdl = &fdl
let s:l = 730 - ((15 * winheight(0) + 16) / 32)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 418 - ((0 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 418
...
silent! normal! zE
let &fdl = &fdl
let s:l = 215 - ((12 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 215
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40 - ((0 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 40
...
silent! normal! zE
let &fdl = &fdl
let s:l = 28 - ((15 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 28
...
silent! normal! zE
let &fdl = &fdl
let s:l = 289 - ((22 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 289
...
silent! normal! zE
let &fdl = &fdl
let s:l = 67 - ((21 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 67
...
silent! normal! zE
let &fdl = &fdl
let s:l = 50 - ((0 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 50
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 27 + 18) / 36)
exe 'vert 1resize ' . ((&columns * 95 + 96) / 192)
exe '2resize ' . ((&lines * 27 + 18) / 36)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 62 - ((11 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 62
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 26 + 18) / 36)
exe 'vert 1resize ' . ((&columns * 112 + 96) / 192)
exe '2resize ' . ((&lines * 26 + 18) / 36)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 175 - ((24 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 175
...
silent! normal! zE
let &fdl = &fdl
let s:l = 20 - ((8 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 20
