...
badd +296 include/statistics/dataVector.cpp
...
badd +177 include/gui/vectorContainer.cpp
badd +35 include/gui/vectorContainer.hpp
badd +22 CMakeLists.txt
badd +81 include/gui/vectorPicker.cpp
badd +44 include/gui/vectorPicker.hpp
badd +5351 exprtk_cmake/readme.txt
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 37 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 37
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((10 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 22
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((32 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 51
...
silent! normal! zE
let &fdl = &fdl
let s:l = 177 - ((31 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 177
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((34 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 41
...
silent! normal! zE
let &fdl = &fdl
let s:l = 27 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 27
...
silent! normal! zE
let &fdl = &fdl
let s:l = 81 - ((30 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 81
...
silent! normal! zE
let &fdl = &fdl
let s:l = 36 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 36
...
silent! normal! zE
let &fdl = &fdl
let s:l = 16 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 16
...
silent! normal! zE
let &fdl = &fdl
let s:l = 306 - ((25 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 306
...
silent! normal! zE
let &fdl = &fdl
let s:l = 5351 - ((21 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 5351
...
silent! normal! zE
let &fdl = &fdl
let s:l = 31 - ((23 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
...
silent! normal! zE
let &fdl = &fdl
let s:l = 12 - ((0 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 12
